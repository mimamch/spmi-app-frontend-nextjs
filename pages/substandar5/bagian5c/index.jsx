          ...
          <tbody>
            {data.map((e, i) => (
              <tr key={i}>
                ...
                <td>{e.aspekYangDiukur}</td>
                <td>{e.tingkatKepuasanMahasiswa.sangatBaik + "%"}</td>
                <td>{e.tingkatKepuasanMahasiswa.baik + "%"}</td>
                <td>{e.tingkatKepuasanMahasiswa.cukup + "%"}</td>
                <td>{e.tingkatKepuasanMahasiswa.kurang + "%"}</td>
