...
export default function Bagian1() {
  return (
    <>
      <Head>
        <title>Substandar5 - Bagian 5-C</title>
      </Head>
      <Wrapper>
                ...
                >
                  <thead>
                    <tr>
                      ...
                      <th rowSpan="2" className="text-center">Aspek yang Diukur</th>
                      <th colSpan="4" className="text-center">Tingkat Kepuasan Mahasiswa (%)</th>
                      <th rowSpan="2"  className="text-center">Rencana Tindak Lanjut oleh UPPS/PS</th>
                    ...
                    <tr>
                      ...
                      <td className="text-center">Cukup</td>
                      <td className="text-center">Kurang</td>  
                    </tr>
                  </thead>
                  <tbody>
                    {/* <tr>
