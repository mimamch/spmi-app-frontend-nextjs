...
export default function Bagian1() {
  return (
    <>
      <Head>
        <title>Substandar1 - Bagian 1-3</title>
      </Head>
      <Wrapper>
        <div className="container-fluid">
          {/* <!-- Page Heading --> */}
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">Tabel 1 Bagian-3 Kerjasama Pengabdian kepada Masyarakat</h1>
          </div>
          <div className="card shadow mb-4">
            <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-primary">Table 1-3</h6>
            </div>
