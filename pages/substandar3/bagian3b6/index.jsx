      ...
      <Wrapper>
        <div className="container-fluid">
          ...
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">Tabel 3.b.6 Produk/Jasa DTPS yang Diadopsi oleh Industri/Masyarakat</h1>
          </div>
        ...
        <thead>
            <tr>
                ...
                <th className="text-center">Nama Produk/Jasa</th>
