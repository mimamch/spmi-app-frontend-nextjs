      ...
      <Wrapper>
        <div className="container-fluid">
          ...
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">Tabel 3.b.4 Publikasi Ilmiah DTPS</h1>
          </div>
          <div className="card shadow mb-4">
            <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-primary">Table 3-B-4-1</h6>
              <h6 className="m-0 font-weight-bold text-primary">Diisi oleh pengusul dari Program Studi pada program Sarjana/Magister/Doktor.</h6>
            </div>
