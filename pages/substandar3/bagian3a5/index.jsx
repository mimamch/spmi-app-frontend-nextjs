      ...
      <Wrapper>
        <div className="container-fluid">
          ...
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">Tabel 3.a.5 Dosen Industri/Praktisi</h1>
            <h6 className="h3 mb-0 text-gray-800">Diisi oleh pengusul dari Program Studi pada program Diploma Tiga dan program Sarjana Terapan</h6>
          </div>
          <div className="card shadow mb-4">
            <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-primary">Table 3-A-5</h6>
            </div>
