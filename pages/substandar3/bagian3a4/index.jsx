      ...
      <Wrapper>
        <div className="container-fluid">
          ...
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">Tabel 3.a.4 Dosen Tidak Tetap </h1>
          </div>
          <div className="card shadow mb-4">
            <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-primary">Table 3-A-4</h6>
            </div>
        ...
        <thead>
            <tr>
                ...
                <th className="text-center">Sertifikat Pendidik Nasional</th>
                <th className="text-center">Sertifikat Kompetensi/Profesi/Industri</th>
                <th className="text-center">Mata Kuliah yang Diampu pada PS yang Diakreditasi</th>
                <th className="text-center">Kesesuaian Bidang Keahlian dengan Mata Kuliah yang Diampu</th>
