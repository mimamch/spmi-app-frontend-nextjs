      ...
      <Wrapper>
        <div className="container-fluid">
          ...
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">Tabel 3.b.4 Pagelaran/Pameran/Presentasi/Publikasi Ilmiah DTPS</h1>
          </div>
          <div className="card shadow mb-4">
            <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-primary">Table 3-B-4-2</h6>
              <h6 className="m-0 font-weight-bold text-primary">Diisi oleh pengusul dari Program Studi pada program Diploma Tiga/Sarjana Terapan/Magister Terapan/Doktor Terapan.</h6>
            </div>
        ...
        <thead>
            <tr>
                ...
                <th rowSpan="2" className="text-center">Jenis Publikasi</th>
                <th colSpan="3" className="text-center">Jumlah Judul</th>
