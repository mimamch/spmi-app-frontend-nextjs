...
export default function Bagian1() {
  return (
    <>
      <Head>
        <title>Substandar8 - Bagian 8-F-1-2</title>
      </Head>
      <Wrapper>
        <div className="container-fluid">
          ...
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            Tabel 8.f.1.2 Pagelaran/Pameran/Presentasi/Publikasi Ilmiah Mahasiswa
            </h1>
          </div>
          <div className="card shadow mb-4">
            <div className="card-header py-3">
              <h6 className="m-0 font-weight-bold text-primary">Table 8-F-1-2</h6>
