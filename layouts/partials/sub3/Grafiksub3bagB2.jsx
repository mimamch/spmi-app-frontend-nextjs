...
export default function GrafikSub3BagianB2() {
  const [data, setdata] = useState({});
  const getData = async () => {
    try {
      const result = await axios.get(
        `${process.env.NEXT_PUBLIC_API_ENDPOINT}/grafik/sub3/bagB2`
      );
  ...
  return (
    <div className="card shadow mb-4">
      <div className="card-body mb-3">
        <h4 className="card-title p-2 text-dark ">Substandar 3 Bagian B2</h4>
        <div className="row justify-content-around">
          ...
          <div className="col-md-3 ">
            ...
            <Bar
              ...
              data={{
                labels: Object.keys(data.jumlahJudulPenelitian || {}),
                datasets: [
                  {
                    label: "#",
                    data: Object.values(data.jumlahJudulPenelitian || {}),
                    backgroundColor: [
                      "rgba(255, 99, 132, 0.2)",
                      "rgba(54, 162, 235, 0.2)",
                      "rgba(255, 206, 86, 0.2)",
