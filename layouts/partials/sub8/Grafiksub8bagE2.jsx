...
export default function GrafikSub8BagianE2() {
  const [data, setdata] = useState({});
  const getData = async () => {
    try {
      const result = await axios.get(
        `${process.env.NEXT_PUBLIC_API_ENDPOINT}/grafik/sub8/bag8E2`
      );
  ...
  return (
    <div className="card shadow mb-4">
      <div className="card-body mb-3">
        <h4 className="card-title p-2 text-dark ">Substandar 8 Bagian E2 </h4>
