...
export default function GrafikSub8BagianC() {
  const [data, setdata] = useState({});
  const getData = async () => {
    try {
      const result = await axios.get(
        `${process.env.NEXT_PUBLIC_API_ENDPOINT}/grafik/sub8/bag8C`
      );
  ...
  return (
    <div className="card shadow mb-4">
      <div className="card-body mb-3">
        <h4 className="card-title p-2 text-dark ">Substandar 8 Bagian C </h4>
        <div className="row justify-content-around">
          ...
          <div className="col-md-3 ">
            ...
            <Bar
              ...
              data={{
                labels: Object.keys(data.jumlahMahasiswaYangLulusPada || {}),
                datasets: [
                  {
                    label: "#",
                    data: Object.values(
                      data.jumlahMahasiswaYangLulusPada || {}
                    ),
                    backgroundColor: [
                      "rgba(255, 99, 132, 0.2)",
                      "rgba(54, 162, 235, 0.2)",
